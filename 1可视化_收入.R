...
pfun=function(time){
  ...
  ph2=ggplot()+
    ...
    annotate('text',x=2,y=ave,label=paste('平均数:',ave))+
    scale_fill_gradient(high='darkred',low='gray')+
    labs(x='',y='城镇居民人均可支配收入(元)',fill='')+
    theme_bw()+
...
for(time in c('2015.03','2015.06','2015.09','2015.12','2016.03','2016.06','2016.09','2016.12')){
  pdf(paste('城镇居民人均可支配收入',time,'.pdf',sep=''),height=5,width=10)
  pfun(time)
  dev.off()
}
